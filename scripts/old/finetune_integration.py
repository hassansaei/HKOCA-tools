...
hyperparameter_defaults = dict(
    seed=42,
    dataset_name="HKOCA_snapseed_individual_annotated",
    do_train=True,
    load_model="/out/scGPT/model/",
    mask_ratio=0.4,
    epochs=30,
    n_bins=51,
...
save_dir = Path(f"/mnt/scGPT/save/dev_{dataset_name}-{time.strftime('%b%d-%H-%M')}/")
...
adata.obs["celltype"] = adata.obs["level_2"].astype("category")
